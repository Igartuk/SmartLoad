...
// Validate ../../src/app/packing/[shortUrl]/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/packing/[shortUrl]">> =
    Specific;
  const handler = {} as typeof import("../../src/app/packing/[url]/page.js");
  type __Check = __IsExpected<typeof handler>;
  // @ts-ignore
  type __Unused = __Check;
}
