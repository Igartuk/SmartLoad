...
import type { LoadingPlanResponse } from "../model/types";

interface PackingResultDisplayProps {
  loadingPlan: LoadingPlanResponse;
}

export function PackingResultDisplay({ loadingPlan }: PackingResultDisplayProps) {
  return (
